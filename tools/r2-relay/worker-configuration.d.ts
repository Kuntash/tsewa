/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../tools/r2-relay/wrangler.jsonc ../../tools/r2-relay/worker-configuration.d.ts` (hash: 1ee26f6d496f17cedb0e749c4af0ac43)
// Runtime types generated with workerd@1.20260730.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
  SOURCE_FILES: R2Bucket;
  TARGET_FILES: R2Bucket;
  RELAY_TOKEN: string;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAY_TOKEN">> {}
}
