import { groupLabel } from "@/lib/access-control";
...
export function buildInvitationEmail(input: InvitationEmailInput) {
  ...
  const roles = input.roleNames.length ? input.roleNames.join(", ") : "No functional roles";
